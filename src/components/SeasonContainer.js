...
class SeasonContainer extends Component{
    ...
    displaySeasons(){
        ...
        const display = this.state.data.map((season, idx) => {
            return <Season key={idx} url={season.url} title={season.title} imageUrl={season.image_url} synopsis={season.synopsis}/>
        });
        return display;
    }
